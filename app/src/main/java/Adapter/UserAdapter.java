...
import com.example.ssquar2chat.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.user_item_username.setText(user.getUsername());
        if (user.getImageURL().equals("default")){
            holder.user_item_image.setImageResource(R.mipmap.ic_launcher);
        }else {
            Glide.with(mContext).load(user.getImageURL()).into(holder.user_item_image);
        }
